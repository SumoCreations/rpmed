...
const Container = styled.div`
  ...
  border: 1px solid ${(p: any) => p.theme.colorContentAreaBorderSelected};
  box-shadow: 5px 5px 10px
    ${(p: any) => transparentize(0.75)(p.theme.colorContentAreaBorderSelected)};
  padding: 0;
  margin: 4px 0 0 0;
  z-index: 1;
  max-height: 400px;
...
const Suggestion = styled.div`
  ...
  border-bottom: 1px solid
    ${(p: any) => transparentize(0.7)(p.theme.colorContentAreaBorderSelected)};
  &:hover {
    background: ${(p: any) => transparentize(0.9)(p.theme.colorPrimary)};
  }
`
...
export const AutocompleteSuggestion: React.FunctionComponent<IAutocompleteSuggestion> = (
  p: any
) => (
  <Suggestion>
