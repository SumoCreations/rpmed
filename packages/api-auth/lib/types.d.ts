...
export declare type TokenResult = TokenInput | undefined;
/**
 * A block that is used to authenticate an email/pass combo
 * in a parent module.
 */
export declare type AuthVerifyPasswordFunction = (params: {
    email: string;
    password: string;
 ...
 * in a parent module.
 */
export declare type AuthVerifyUserIdFunction = (params: {
    userId: string;
}) => Promise<TokenResult> | TokenResult;
