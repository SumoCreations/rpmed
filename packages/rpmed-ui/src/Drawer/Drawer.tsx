...
const styles = {
  container:
    'fixed left-0 top-0 w-96 bg-accent flex flex-col p-4 z-40 h-screen text-white',
  title: 'flex text-2xl font-display font-semibold mb-8',
  button: 'w-24 mr-2 flex hover:bg-accent-dark',
  icon: 'm-auto',
  overlay: 'fixed top-0 left-0 w-screen h-screen z-30 bg-primary bg-opacity-10',
}
