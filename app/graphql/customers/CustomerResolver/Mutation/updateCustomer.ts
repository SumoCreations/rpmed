...
import { ErrorCustomerNotFound, ErrorCustomerWithEmailAlreadyExists } from "../customerErrors"
...
export const updateCustomer = async (
  ...
  if (customerWithEmail && customerWithEmail.partitionKey !== customer.partitionKey) {
